...
class MyAppLoading extends StatelessWidget {
  ...
  MyAppLoading({super.key, required this.child}) : _isLoadingNotifier = ValueNotifier(false);

  static MyAppLoading of(BuildContext context) {
    return context.findAncestorWidgetOfExactType<MyAppLoading>()!;
  }
